<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column sortable label="名称" align="center" prop="goodsCname" :show-overflow-tooltip="true" />
      <el-table-column sortable label="类型" align="center" prop="goodsTypeName" :show-overflow-tooltip="true" />
      <el-table-column sortable label="英文" align="center" prop="goodsEname" :show-overflow-tooltip="true" />
      <el-table-column sortable label="价格" align="center" prop="goodsPrice" :show-overflow-tooltip="true" />
      <el-table-column sortable label="描述" align="center" prop="goodsDesc" :show-overflow-tooltip="true" />
