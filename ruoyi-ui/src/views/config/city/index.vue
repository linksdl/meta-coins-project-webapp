<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="cityList" stripe @selection-change="handleSelectionChange">
      ...
      <el-table-column sortable label="中文" align="center" prop="cityCname" :show-overflow-tooltip="true" />
      <el-table-column sortable label="英文" align="left" prop="cityEname" :show-overflow-tooltip="true" />
      <el-table-column sortable label="描述" align="left" prop="cityDesc" :show-overflow-tooltip="true" />
      <el-table-column sortable label="创建时间" align="center" prop="createTime" width="180">
        <template slot-scope="scope">
          <span>{{parseTime(scope.row.createTime, '{y}-{m}-{d} {h}:{i}:{s}')}}</span>
        </template>
      </el-table-column>
      <el-table-column sortable label="国家" align="center" prop="cityCountry" :show-overflow-tooltip="true" />
      <el-table-column sortable label="省份" align="center" prop="cityProvince" :show-overflow-tooltip="true" />
