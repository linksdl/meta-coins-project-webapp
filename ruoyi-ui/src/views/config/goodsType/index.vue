<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="goodsTypeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="名称" align="center" prop="goodsTypeName" :show-overflow-tooltip="true" />
      <el-table-column label="描述" align="center" prop="goodsTypeDesc" :show-overflow-tooltip="true" />
