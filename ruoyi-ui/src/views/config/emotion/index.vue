<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="天气名称" prop="emotionCname">
        <el-input
    ...
    <el-table v-loading="loading" :data="emotionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column sortable label="中文" align="center" prop="emotionCname" :show-overflow-tooltip="true" />
      <el-table-column sortable label="英文" align="center" prop="emotionEname" :show-overflow-tooltip="true" />
      <el-table-column sortable label="作用范围" align="center" prop="emotionScope">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.config_function_scope" :value="scope.row.emotionScope ? scope.row.emotionScope.split(',') : []"/>
        </template>
      </el-table-column>
      <el-table-column sortable label="描述" align="center" prop="emotionDesc" :show-overflow-tooltip="true" />
