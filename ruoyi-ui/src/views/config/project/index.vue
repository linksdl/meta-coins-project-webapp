<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="projectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="名称" align="center" prop="projectName" :show-overflow-tooltip="true" />
      <el-table-column label="功能范围" align="center" prop="projectScope">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.config_function_scope" :value="scope.row.projectScope ? scope.row.projectScope.split(',') : []"/>
        </template>
      </el-table-column>
      <el-table-column label="功能类型" align="center" prop="projectType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.config_function_type" :value="scope.row.projectType ? scope.row.projectType.split(',') : []"/>
        </template>
      </el-table-column>
      <el-table-column label="描述" align="center" prop="projectDesc" :show-overflow-tooltip="true" />
