<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="bookTypeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column sortable label="名称" align="center" prop="bookTypeName" :show-overflow-tooltip="true" />
      ...
      <el-table-column sortable label="描述" align="left" prop="bookTypeDesc" :show-overflow-tooltip="true" />
      <el-table-column sortable label="备注" align="left" prop="remark" :show-overflow-tooltip="true" />
