<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="memberTypeList"  @selection-change="handleSelectionChange">
      ...
      <el-table-column sortable label="类型名称" align="center" prop="memberTypeName" :show-overflow-tooltip="true" />
      <el-table-column sortable label="描述" align="center" prop="memberTypeDesc" :show-overflow-tooltip="true" />
